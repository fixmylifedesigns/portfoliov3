...
export const articles: { articles: Article[] } = {
  articles: [
    ...
    {
      id: 7,
      urlName: "fundamental-it-engineer-exam-japan",
      title:
      ...
      summary:
        "Learn how passing the Fundamental Information Technology Engineer (FE) exam—administered by PhilNITS under the ITPEC framework—can help you qualify for engineering work and visa points in Japan, even without a traditional degree.",
      mainImage: "https://i.imgur.com/NXitIw2.png",
      content: [
        {
          id: 1,
          title:
            "What Is the Fundamental Information Technology Engineer (FE) Exam?",
          paragraph:
          ...
          links: [
            { text: "PhilNITS Official Website", url: "https://philnits.org/" },
            { text: "ITPEC Overview", url: "https://itpec.org/" },
          ],
        },
        {
          id: 2,
          title: "Why Does the ITPEC FE Matter for Working in Japan?",
          paragraph:
          ...
          links: [
            {
              text: "Immigration Services Agency Public Notice (資格外活動・高度人材ポイント対象試験)",
              url: "https://www.moj.go.jp/isa/policies/bill/nyukan_hourei_h09.html",
            },
            {
              text: "Points-Based Immigration Treatment (PDF)",
              url: "https://www.lb.emb-japan.go.jp/Points-Based-Immigration-Treatment.PDF",
            },
          ],
        },
        {
        ...
        {
          id: 4,
          title: "How to Register (Philippines Example)",
          paragraph:
          ...
          links: [
            {
              text: "PhilNITS Exam Schedule & Registration",
              url: "https://philnits.org/exam-schedule",
            },
          ],
        },
        {
          id: 5,
          title: "Exam Structure and Topics",
          paragraph:
          ...
          links: [
            {
              text: "Detailed Syllabus (PDF)",
              url: "https://philnits.org/docs/fe_syllabus.pdf",
            },
          ],
        },
        {
        ...
        {
          id: 7,
          title: "Recognition Outside Japan",
          paragraph:
